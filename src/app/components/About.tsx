...
import { GraduationCap, Target, Zap, ChevronDown, Calendar, MapPin, School, X, Award, Brain } from 'lucide-react';
    ...
    <section id="about" className="relative py-32 bg-gradient-to-b from-background to-secondary overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-primary to-violet-500 mx-auto" />
        </motion.div>
            ...
            {highlights.map((item, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-lg bg-gradient-to-br from-primary/20 to-violet-500/20 border border-primary/20">
        ...
        >
          {stats.map((stat, index) => (
            <div
              key={index}
              className="text-center p-6 rounded-xl bg-foreground/5 border border-foreground/10 backdrop-blur-sm"
            >
              <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-primary to-violet-400 bg-clip-text text-transparent mb-2">
                {stat.value}
              </div>
            ...
            >
              ...
              <div className="flex flex-col items-center text-center mb-16 px-4">
                <motion.div
                  ...
                  className="w-20 h-20 rounded-3xl bg-gradient-to-br from-primary to-violet-500 p-5 shadow-2xl shadow-primary/20 mb-6 flex items-center justify-center"
                >
                ...
                >
                  Mon aventure dans le monde de l'informatique
                </motion.p>
              </div>
                    ...
                    <div className="p-8 rounded-[2rem] bg-foreground/[0.03] border border-foreground/5 hover:bg-foreground/[0.05] hover:border-primary/20 transition-all duration-500 hover:shadow-xl hover:shadow-primary/5">
                      <div className="flex flex-col md:flex-row md:items-start gap-6">
                        ...
                        <div className="flex flex-row md:flex-col items-center gap-4 flex-shrink-0">
                          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary/10 to-violet-500/10 flex items-center justify-center group-hover/edu:scale-110 transition-transform duration-500 border border-primary/10">
              ...
              <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-violet-500/10 rounded-full blur-[100px] pointer-events-none" />
            </motion.div>
          </div>
        )}
      </AnimatePresence>
