                    ...
                    {menuItems.map((item, index) => (
                        <motion.button
                            ...
                            className={`group flex items-center justify-between p-6 rounded-2xl border transition-all duration-300 text-left ${currentView === item.id
                                ? 'bg-foreground/10 border-primary/50'
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <span className={`block text-2xl font-bold mb-1 ${currentView === item.id ? 'text-primary' : 'text-foreground group-hover:text-primary'
                                        }`}>
                                        {t(item.labelKey)}
                                    </span>
                            ...
                            <motion.div
                                className={`w-3 h-3 rounded-full ${currentView === item.id ? 'bg-primary' : 'bg-foreground/10'}`}
